...
namespace Ewamall.Infrastructure.Migrations
{
    ...
    [Migration("20240513033811_FirstDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ewamall.Domain.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Ewamall.Domain.Entities.ProductDetail", "ProductDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("Ewamall.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Ewamall.Domain.Entities.Payment", null)
                        .WithMany("Payments")
                        .HasForeignKey("PaymentId");
                });
            ...
            modelBuilder.Entity("Ewamall.Domain.Entities.ProductSellDetail", b =>
                {
                    b.HasOne("Ewamall.Domain.Entities.ProductDetail", "ParentNode")
                        .WithMany()
                        .HasForeignKey("ParentNodeId");
