        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Industries_Industries_ParentNodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndustryDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndustryDetails_Details_DetailId",
                        column: x => x.DetailId,
                        principalTable: "Details",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndustryDetails_Industries_IndustryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vouchers_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSellDetails", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductSellDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    SellDetailId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Carts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Carts_ProductSellDetails_SellDetailId",
                        column: x => x.SellDetailId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectWithSellProduct = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ProductSellDetailId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedBacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeedBacks_ProductSellDetails_ProductSellDetailId",
                        column: x => x.ProductSellDetailId,
                        principalTable: "ProductSellDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedBacks_ProductSellDetailId",
                table: "FeedBacks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Industries_ParentNodeId",
                table: "Industries",
                column: "ParentNodeId");

            migrationBuilder.CreateIndex(
                name: "IX_IndustryDetails_DetailId",
                table: "IndustryDetails",
                column: "DetailId");

            migrationBuilder.CreateIndex(
                name: "IX_IndustryDetails_IndustryId",
                table: "IndustryDetails",
                column: "IndustryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSellDetails_ParentNodeId",
                table: "ProductSellDetails",
                column: "ParentNodeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSellDetails_ProductId",
                table: "ProductSellDetails",
                column: "ProductId");
